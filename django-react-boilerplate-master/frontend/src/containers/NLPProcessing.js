...
import { usermove_nlp, api_request } from "../store/actions/user";
                    ...
                    <div className="col-md-8 row column">
                        ...
                        <div className="col-sm-6">
                            ...
                            <div className="form-group mid">
                                <textarea class="form-control" rows="15" id="textcapture"></textarea>
                            </div>
                            <Button className="btn btn-success result darkyellow" onClick={this.send_api_request}><h5 className="georgia">{this.state.buttoncaption}</h5></Button>
                        </div>
                        <div className="col-sm-3 gray">
